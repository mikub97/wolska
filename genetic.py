...
class GeneticAlgorithm():
    ...
    # Teraz, sprawdzam połączenia powmiędzy każdym z węzłów potencalnego rozwiązania,
    ...
    # Selekcja turniejowa turniej k - osobnikowy
    def select(self,population, evaluation_results, k=3):
        pop2 = []
        for i in range(self.POP_SIZE):
            indexes = []
            results = []
